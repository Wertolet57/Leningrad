!function (a, b, c, d) {
    ...
    e.Private = {
        resizeEventArray: [], initResizeEvent: function (a) {
            ...
            var d = e.Private, f = a.map(d.resizeEventArray, function (a) {
    ...
    b.prototype.filterLayout = function () {
        ...
        d.sortBlocks(f, "top"), f.children(".cbp-item-wrapper").each(function (a, b) {
            ...
            var e = d.blocksOn.length, g = f.length;
    ...
    a.extend(e.prototype, {
        sliderMarkup: function () {
            ...
            }).appendTo(b.controls), b.controls.appendTo(b.nav)), b.options.showPagination && (b.navPagination = a("<div/>", {"class": "cbp-nav-pagination"}).appendTo(b.nav)), (b.controls || b.navPagination) && b.nav.appendTo(b.$obj), b.updateSliderPagination(), b.options.auto && (b.options.autoPauseOnHover && (b.mouseIsEntered = !1, b.$obj.on("mouseenter.cbp", function () {
